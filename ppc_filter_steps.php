                                        ...
                                        <form action="" method="post">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-6 col-xl-6 m-b-30">
                                                    ...
                                                    <input type="text" name="demand" class="form-control" value="<?php if(isset($_POST['submit'])){ echo $_POST['demand']; }elseif(isset($_GET['demand'])){ echo $_GET['demand']; } ?>">
                                                </div>
                                                    ...
                                                    <tbody> 
                                                        ...
                                                        ?>
                                                            <tr>
                                                                ...
                                                                <td <?php if($rowdb2['STATUS_OPERATION'] == 'Closed'){ echo 'bgcolor="#B5533E"'; }elseif($rowdb2['STATUS_OPERATION'] == 'Progress'){ echo "bgcolor='#41CC11'"; }else{ echo "bgcolor='#ECECEC'"} ?>><?= $rowdb2['STATUS_OPERATION']; ?></td>
