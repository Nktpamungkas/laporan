                                        ...
                                        <form action="" method="post">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-12 col-xl-2 m-b-30">
                                                    ...
                                                    ?>
                                                    <select class="form-control input-xl" name="dept">
                                                ...
                                                <table id="lang-dt" class="table table-striped table-bordered nowrap">
                                                    ...
                                                    <tbody> 
                                                        <?php 
                                                            ...
                                                            if($dept){
                                                                $q_carigerobak      = db2_exec($conn1, "SELECT 
                                                                                                            ...
                                                                                                            FROM
                                                                                                                ...
                                                                                                                WHERE 
                                                                                                                    ...
                                                                                                                    AND p.CREATIONDATETIME BETWEEN '2024-03-01' AND '2024-03-02'
                                                                                                                    AND NOT p.PRODUCTIONORDERCODE IS NULL)
                                                                                                            WHERE
                                                                                                                RN = 1
                                                                                                                AND NOT OPERATIONCODE = 'BAT1'");
                                                                while ($row_carigerobak   = db2_fetch_assoc($q_carigerobak)) {
                                                                    $r_carigerobak[]      = "'".TRIM(addslashes($row_carigerobak['PRODUCTIONDEMANDCODE']))."'";
                                                                }
                                                                $value_carigerobak        = implode(',', $r_carigerobak);
                                                                $where_proddemand         = "DEMAND IN ($value_carigerobak)";
                                                            }else{
                                                                if($prod_order){
                                                            ...
                                                            if($dept){
                                                                $where_proddemand2         = "DEMAND IN ($value_carigerobak)";
                                                            }else{
                                                                if($prod_order_2){
